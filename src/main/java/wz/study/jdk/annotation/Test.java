package wz.study.jdk.annotation;
...
public class Test {
    ...
    public static String assembleSqlFromObj(Object obj) {
        Table table = obj.getClass().getAnnotation(Table.class); //通过对象，获取该对象的类的相关信息（类的相关信息包括：①用了什么注解 ②类的名称 ③各成员变量的名称等。本例中是通过对象testDto、testDto1、testDto2获取类的名为“Table”的注解），这里就用到了java的反射机制。
